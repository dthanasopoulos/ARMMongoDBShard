...
The nodes are under the same subnet 10.100.6.0/24. Except the 2 router server nodes, the other nodes only have private IP address.
...
- More MongoDB usage details please visit MongoDB website https://www.mongodb.org/ .# ARMMongoDBShard
