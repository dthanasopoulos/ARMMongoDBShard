...
#start router server
mongos --configdb crepset/10.100.6.240:27019,10.100.6.241:27019,10.100.6.242:27019 --port 27017 --logpath /var/log/mongodb/mongos.log --fork --keyFile /etc/mongokeyfile
...
sh.addShard("repset1/10.100.6.100:27017")
sh.addShard("repset2/10.100.6.110:27017")
